  ...
  return (
    <Page className="c-container flex items-center justify-center min-h-screen">
      ...
      <article className="pt-[80px] sm:pt-0">
        <Card className="min-h-screen sm:min-h-fit w-screen sm:w-full max-w-[824px] py-6 text-primary font-semibold border-0 sm:border rounded-none sm:rounded-[20px]">
